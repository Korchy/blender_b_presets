...
class RENDER_PRESETS_OT_messagebox(Operator):
    bl_idname = 'render_presets.messagebox'
    bl_label = ''
...
def register():
    register_class(RENDER_PRESETS_OT_messagebox)


def unregister():
    unregister_class(RENDER_PRESETS_OT_messagebox)
